...
class ConvexHull(BaseModel, Computable, Expandable):
    """Generated from GraphQL object ConvexHull."""
    ...
    hull_lines: Optional[List[Line]] = Field(default=None, json_schema_extra={'compute': {'fn': 'compute_convex_hull_lines'}})
    result: Optional[Polygon] = Field(default=None, json_schema_extra={'expand': {'into': {'lines': '$hull_lines'}}})
