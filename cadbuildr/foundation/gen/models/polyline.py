...
class Polyline(BaseModel, Computable, Expandable):
    """Generated from GraphQL object Polyline."""
    ...
    primitives: Optional[List[BoundaryElement2D]] = Field(default=None, json_schema_extra={'compute': {'fn': 'compute_polyline_primitives'}})
