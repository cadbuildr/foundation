...
class Bezier(BaseModel, Computable):
    """Generated from GraphQL object Bezier."""
    ...
    def translate(self, dx: float, dy: float) -> Optional[Bezier]:
    ...
    def rotate(self, angle: float, center: Optional[Point]=None) -> Optional[Bezier]:
        # Build local namespace with parameters for method function
        _locals = {
            'angle': angle,
            'center': center
