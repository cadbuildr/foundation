...
class CounterSinkHole(ParameterFieldsMixin, BaseModel, Computable, Expandable):
    """Generated from GraphQL object CounterSinkHole."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        use_normal, processed_kwargs = _init_with_cast(
            ...
            kwargs,
            cast_info=None,
            field_order=['point', 'radius', 'depth', 'csink_radius', 'csink_angle_deg'],
    ...
    csink_radius: FloatParameter = Field(...)
    csink_angle_deg: FloatParameter = Field(...)
    primitives: Optional[List[Line]] = Field(default=None, json_schema_extra={'compute': {'fn': 'compute_countersink_profile_lines'}})
