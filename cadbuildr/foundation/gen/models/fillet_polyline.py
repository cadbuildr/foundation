...
class FilletPolyline(ParameterFieldsMixin, BaseModel, Computable, Expandable):
    """Generated from GraphQL object FilletPolyline."""
    ...
    primitives: Optional[List[BoundaryElement2D]] = Field(default=None, json_schema_extra={'compute': {'fn': 'compute_fillet_polyline_primitives'}})
    result: Optional[CustomOpenShape] = Field(default=None, json_schema_extra={'expand': {'into': {'primitives': '$primitives'}}})
