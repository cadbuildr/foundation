...
class RadiusArc(ParameterFieldsMixin, BaseModel, Computable, Expandable):
    """Generated from GraphQL object RadiusArc."""
    ...
    result: Optional[ArcFromTwoPointsAndRadius] = Field(default=None, json_schema_extra={'expand': {'into': {'p1': '$p1', 'p2': '$p3', 'radius': '$radius', 'sketch': '$sketch'}}})
