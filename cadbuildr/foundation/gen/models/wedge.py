...
class Wedge(ParameterFieldsMixin, BaseModel):
    """Generated from GraphQL object Wedge."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        use_normal, processed_kwargs = _init_with_cast(
            ...
            kwargs,
            cast_info=None,
            field_order=['center', 'dx', 'dy', 'dz', 'ltx'],
            list_fields=None,
        )
        if use_normal:
    ...
    center: Point = Field(...)
    dx: FloatParameter = Field(...)
    dy: FloatParameter = Field(...)
    dz: FloatParameter = Field(...)
    ltx: FloatParameter = Field(...)
