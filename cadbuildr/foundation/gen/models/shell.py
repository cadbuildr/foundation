...
class Shell(ParameterFieldsMixin, BaseModel):
    """Generated from GraphQL object Shell."""
    ...
    face_finder: Optional[EdgeFinder] = Field(default=None)
