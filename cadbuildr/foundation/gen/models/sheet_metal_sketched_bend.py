...
from .enums import BendPosition

class SheetMetalSketchedBend(ParameterFieldsMixin, BaseModel, Computable):
    """Generated from GraphQL object SheetMetalSketchedBend."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        use_normal, processed_kwargs = _init_with_cast(
            ...
            kwargs,
            cast_info=None,
            field_order=['body', 'fold_line', 'angle'],
            list_fields=None,
        )
        if use_normal:
    ...
    fold_line: Line = Field(...)
    angle: FloatParameter = Field(default_factory=lambda: _eval_expr({}, 'FloatParameter(value=90.0)'), json_schema_extra={'default': {'expr': 'FloatParameter(value=90.0)'}})
    fixed_face: Optional[Plane] = Field(default=None)
    bend_position: BendPosition = Field(default_factory=lambda: _eval_expr({}, 'BendPosition.BEND_CENTERLINE'), json_schema_extra={'default': {'expr': 'BendPosition.BEND_CENTERLINE'}})
