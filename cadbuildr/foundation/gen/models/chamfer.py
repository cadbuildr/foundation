...
class Chamfer(ParameterFieldsMixin, BaseModel):
    """Generated from GraphQL object Chamfer."""
    ...
    edge_finder: Optional[EdgeFinder] = Field(default=None)
