...
class Split(ParameterFieldsMixin, BaseModel, Computable):
    """Generated from GraphQL object Split."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        use_normal, processed_kwargs = _init_with_cast(
            ...
            kwargs,
            cast_info=None,
            field_order=['solid', 'plane_name', 'keep'],
            list_fields=None,
        )
        if use_normal:
    ...
    plane_name: StringParameter = Field(...)
    keep: StringParameter = Field(default_factory=lambda: _eval_expr({}, 'StringParameter(value="TOP")'), json_schema_extra={'default': {'expr': 'StringParameter(value="TOP")'}})
