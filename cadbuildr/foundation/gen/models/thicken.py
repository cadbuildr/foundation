...
class Thicken(ParameterFieldsMixin, BaseModel, Computable):
    """Generated from GraphQL object Thicken."""
    ...
    surface: SurfaceOperation = Field(...)
    thickness: FloatParameter = Field(...)
    both_sides: BoolParameter = Field(default_factory=lambda: _eval_expr({}, 'BoolParameter(value=False)'), json_schema_extra={'default': {'expr': 'BoolParameter(value=False)'}})
