...
class Square(SketchElementMixin, BaseModel, Computable, Expandable):
    """Generated from GraphQL object Square."""
    ...
    def from_center_and_side(center, size) -> Optional[Square]:
        ...
        return _eval_expr(None, 'SquareFromCenterAndSide(center=center, size=size, sketch=center.sketch).expand()', _locals)
    def get_points(self) -> Optional[List[Point]]:
        # Build local namespace with parameters for instance method
        _locals = None
        return _eval_expr(self, '[p1, p2, p3, p4]', _locals)
