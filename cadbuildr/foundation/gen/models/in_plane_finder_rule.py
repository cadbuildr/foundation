...
class InPlaneFinderRule(ParameterFieldsMixin, BaseModel, Computable):
    """Generated from GraphQL object InPlaneFinderRule."""
    ...
    plane: Plane = Field(...)
    distance: FloatParameter = Field(default_factory=lambda: _eval_expr({}, 'FloatParameter(value=0.0)'), json_schema_extra={'default': {'expr': 'FloatParameter(value=0.0)'}})
