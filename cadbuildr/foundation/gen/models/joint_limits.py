...
class JointLimits(ParameterFieldsMixin, BaseModel):
    """Generated from GraphQL object JointLimits."""
    ...
    min: Optional[FloatParameter] = Field(default=None)
    max: Optional[FloatParameter] = Field(default=None)
