...
class Trace(ParameterFieldsMixin, BaseModel, Computable):
    """Generated from GraphQL object Trace."""
    ...
    path_points: List[Point] = Field(...)
    width: FloatParameter = Field(...)
    sketch: Optional[Sketch] = Field(default=None, json_schema_extra={'compute': {'expr': 'path_points[0].sketch if path_points else None'}})
