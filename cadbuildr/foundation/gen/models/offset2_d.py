...
class Offset2D(ParameterFieldsMixin, BaseModel, Computable):
    """Generated from GraphQL object Offset2D."""
    ...
    sketch: Optional[Sketch] = Field(default=None, json_schema_extra={'compute': {'expr': 'shape.sketch'}})
