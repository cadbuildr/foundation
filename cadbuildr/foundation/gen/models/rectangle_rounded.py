...
class RectangleRounded(ParameterFieldsMixin, BaseModel, Computable, Expandable):
    """Generated from GraphQL object RectangleRounded."""
    ...
    primitives: Optional[List[BoundaryElement2D]] = Field(default=None, json_schema_extra={'compute': {'fn': 'compute_rounded_rectangle_primitives'}})
