...
from foundation.finders.base import EdgeFinder


class FilletChildren(NodeChildren):
    solid: Extrusion | Lathe
    radius: FloatParameter
    edge_finder: EdgeFinder


class Fillet(Operation, Node):
    children_class = FilletChildren
...
FilletChildren.__annotations__["solid"] = Extrusion | Lathe
FilletChildren.__annotations__["radius"] = FloatParameter
FilletChildren.__annotations__["edge_finder"] = EdgeFinder
